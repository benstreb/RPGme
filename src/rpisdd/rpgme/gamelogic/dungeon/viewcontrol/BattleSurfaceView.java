...
public class BattleSurfaceView extends SurfaceView implements
	...
	public void monsterTurn() {
		...
		if (monsterModel.getEnergy() <= 0) {
			...
			int dmg = Player.getPlayer().takeDamage(monsterModel.MakeAttack());
			...
			/*
			 * System.out
			 * .println(Integer.toString(Player.getPlayer().getEnergy()));
			 * System.out.println(Integer.toString(Player.getPlayer()
			 * .getMaxEnergy()));
			 */
