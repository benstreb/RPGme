...
public class ItemDatabase extends SQLiteOpenHelper {
	...
	private String SQL_CREATE_ENTRIES =
	    "CREATE TABLE IF NOT EXISTS " + ItemFeedEntry.TABLE_NAME + " (" +
	    ItemFeedEntry._ID + " INTEGER PRIMARY KEY," +
	    ItemFeedEntry.COLUMN_NAME_ITEM_NAME + TEXT_TYPE +
	    " )";

	private String SQL_DELETE_ENTRIES =
	    "DROP TABLE IF EXISTS " + ItemFeedEntry.TABLE_NAME;
